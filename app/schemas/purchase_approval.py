...
class BoxSchema(BaseModel):
    ...
    box_id: Optional[int] = Field(default=None, serialization_alias="boxId")
    box_number: Optional[str] = Field(default=None, serialization_alias="boxNumber")
    article_name: Optional[str] = Field(default=None, serialization_alias="articleName")
    lot_number: Optional[str] = Field(default=None, serialization_alias="lotNumber")
    net_weight: Optional[Decimal] = Field(default=None, serialization_alias="netWeight")
    gross_weight: Optional[Decimal] = Field(default=None, serialization_alias="grossWeight")
    count: Optional[int] = Field(default=None, serialization_alias="count")
...
class ItemSchema(BaseModel):
    ...
    material_type: Optional[str] = Field(default=None, serialization_alias="materialType")
    item_category: Optional[str] = Field(default=None, serialization_alias="itemCategory")
    sub_category: Optional[str] = Field(default=None, serialization_alias="subCategory")
    item_description: Optional[str] = Field(default=None, serialization_alias="itemDescription")
    quantity_units: Optional[Decimal] = Field(default=None, serialization_alias="quantityUnits")
    pack_size: Optional[Decimal] = Field(default=None, serialization_alias="packSize")
    uom: Optional[str] = Field(default=None, serialization_alias="uom")
    net_weight: Optional[Decimal] = Field(default=None, serialization_alias="netWeight")
    gross_weight: Optional[Decimal] = Field(default=None, serialization_alias="grossWeight")
    lot_number: Optional[str] = Field(default=None, serialization_alias="lotNumber")
    mfg_date: Optional[date] = Field(default=None, serialization_alias="mfgDate")
    exp_date: Optional[date] = Field(default=None, serialization_alias="expDate")
    # Article/Item Financial Information (optional - not displayed in approval form)
    hsn_code: Optional[int] = Field(default=None, serialization_alias="hsnCode")
    price_per_kg: Optional[Decimal] = Field(default=None, serialization_alias="pricePerKg")
    taxable_value: Optional[Decimal] = Field(default=None, serialization_alias="taxableValue")
    gst_percentage: Optional[Decimal] = Field(default=None, serialization_alias="gstPercentage")
